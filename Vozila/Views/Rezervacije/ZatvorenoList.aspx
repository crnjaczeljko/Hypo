...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table id="hor-minimalist-b">
        ...
        <tr>
            ...
            <td>
                <a href='<%: Url.Action("Delete", new {id = item.id_rez}) %>'>
            ...
            <td>
                <%: Html.DisplayFor(modelItem => item.Lokacije1.Naziv) %>
            </td>

            <td>
                <%: Html.DisplayFor(modelItem => item.Lokacije2.Naziv) %>
            </td>
        </tr>
        <% } %>
    </table>
    <div align="center">
        ...
        <%: Html.ActionLink("< Prev", "ZatvorenoList", new
                    {
        ...
        <% if (Model.HasNextPage)
           { %>
        <%: Html.ActionLink("Next>", "ZatvorenoList", new {page = Model.PageNumber + 1, sortOrder = ViewBag.CurrentSort, currentFilter = ViewBag.CurrentFilter}) %>
        <%: Html.ActionLink(" |>>", "ZatvorenoList", new {page = Model.PageCount, sortOrder = ViewBag.CurrentSort, currentFilter = ViewBag.CurrentFilter}) %>
        <% }
           else
           { %>
            Next> &nbsp;>>
