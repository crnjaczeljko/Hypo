    ...
    <table>
        <tr>
            ...
            <td style="vertical-align: top; width: 459px;">
                ...
                <% Html.BeginForm("PotvrdaEditPage", "Rezervacije", FormMethod.Post, new {id = "validationForm", @class = "edit_form"}); %>

                <h2> Rezervirao i Putnici</h2>
                <hr />
                <table style="width: 100%">
                                        <tr>
                        <td class="col1">Novi Zaposlenik</td>
                         <td class="col2">
                            <% int ime = 0;
                               if (Model.Zaposlenici != null)
                                   ime = Model.id_zaposlenik.Value;

                               Html.DevExpress().ComboBox(
                                     settings =>
                                     {
                                         settings.Name = "id_zaposlenik";
                                         settings.Width = 180;
                                         settings.SelectedIndex = 0;
                                         settings.Properties.IncrementalFilteringMode =
                                                                                IncrementalFilteringMode.StartsWith;
                                         settings.Properties.DropDownStyle = DropDownStyle.DropDown;
                                         settings.CallbackRouteValues = new { Controller = "ComboBox", Action = "CbZaposlenikPartial" };
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            <% int ime1 = 0;
                               if (Model.Zaposlenici1 != null)
                                   ime1 = Model.id_Putnik1.Value;
                    ...
                    <tr>
                        ...
                        <td class="col2">
                            <%
                                int ime2 = 0;
                                if (Model.Zaposlenici2 != null)
                                    ime2 = Model.id_Putnik2.Value;
                                ...
                                Html.DevExpress().ComboBox(
                                    ...
                                    .BindList(ViewData["id_zaposlenik"]).Bind(ime2).Render(); %>
                        </td>
                    </tr>
                    <tr>
                ...
                <table>
                    <tr>
                        <td class="col1" style="width: 206px">Već dodijeljeni automobil</td>
                        <td class="col2" style="width: 210px">
                            <%: Html.DisplayFor(model => model.Automobil.Naziv)%>
                            <%: Html.DisplayFor(model => model.Automobil.RegBr)%>
                        </td>
                    </tr>
                    <tr>
                        <td class="col1" style="width: 206px">Novi automobil</td>
                        <td class="col2" style="width: 210px">
                            <% Html.DevExpress().ComboBox(
                                   settings =>
                                       {
