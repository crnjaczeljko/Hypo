...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% Html.BeginForm("Create", "Rezervacije", FormMethod.Post, new { id = "validationForm", @class = "edit_form" }); %>
            ...
            <td style="border-style: none; border-width: thin;" class="style4">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td class="col2">
                            <% Html.RenderPartial("CbZaposlenikPartial", ViewData["id_zaposlenik"]);%>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="col1">Relacija - Mjesto polaska , odredište/a i mjesto dolaska</td>
                        <td class="col2">
