<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Vozila.Models.vOdobrenoList>>" %>
<%@ Import Namespace="Vozila" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" AsyncRendering="False" 
        ...
        WaitMessageFont-Size="14pt" Width="100%" BorderStyle="Groove" 
            ShowFindControls="False" ShowParameterPrompts="False" ShowRefreshButton="False" 
            style="margin-left: 0px; margin-right: 0px">
        <LocalReport ReportPath="Rpt\Raspored.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>    
    </div>
